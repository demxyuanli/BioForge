...
import type { InstructionEditState } from '../../hooks/useProductionTuningData';

export interface ProductionTuningInstructionEditDialogProps {
...
export const ProductionTuningInstructionEditDialog: React.FC<
  ProductionTuningInstructionEditDialogProps
